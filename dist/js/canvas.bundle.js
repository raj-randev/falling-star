...
function createMonutainRange(numberOfMountains, height, colour) {
  for (var i = 0; i < numberOfMountains; i++) {
    var mountainWidth = canvas.width / numberOfMountains;
    c.beginPath();
...
var backgroundStars;
var ticker = 0;
var randomSpornRate = _utils__WEBPACK_IMPORTED_MODULE_0___default.a.randomIntFromRange(25, 200);
